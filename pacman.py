...
class Cenario(ElementoJogo):
    ...
    def pintar_vitoria(self, tela):
        self.pintar_texto_centro(tela, "P A R A B E N S  V O C E  G A N H O U  ! ! !")
...
class Fantasma(ElementoJogo, Movivel):
    ...
    def pintar(self, tela):
        ...
        contorno = [(px, py + self.tamanho), (px + fatia, py + fatia * 2), (px + fatia * 2, py + fatia // 2),
                    (px + fatia * 3, py), (px + fatia * 5, py), (px + fatia * 6, py + fatia // 2),
...
if __name__ == "__main__":
    ...
    cenario.adcionar_movivel(pacman)
